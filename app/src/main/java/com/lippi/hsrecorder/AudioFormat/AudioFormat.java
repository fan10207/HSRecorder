package com.lippi.hsrecorder.AudioFormat;
...
/**
 * AudioFormat is the parent class of several subclasses that each
...
public class AudioFormat {
    public interface ProgressListener {
        /**
         * Will be called by the AudioFormat subclass periodically
    ...
    public interface Factory {
        public AudioFormat create();
        public String[] getSupportedExtensions();
    }

    static Factory[] sSubclassFactories = new Factory[] {
            FormatAAC.getFactory(),
            FormatAMR.getFactory(),
            FormatMP3.getFactory(),
            FormatWAV.getFactory(),
    };
    ...
    /**
     * Static method to create the appropriate AudioFormat subclass
     * given a filename.
     *
     * TODO: make this more modular rather than hardcoding the logic
     */
    public static AudioFormat create(String fileName,
        ...
        AudioFormat soundFile = factory.create();
